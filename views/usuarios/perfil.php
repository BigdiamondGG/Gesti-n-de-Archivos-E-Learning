                    ...
                    <div class="card-body">
                        <div class="d-flex flex-column align-items-center text-center">
                            <?php if ($data['usuario']['perfil'] == null) {
                                ...
                                $perfil = BASE_URL . 'assets/images/avatars/' .$data['usuario']['perfil'];
                            } ?>
                            ...
                            <div class="mt-3">
                                ...
                                <p class="text-muted font-size-sm"><i class="fas fa-user-gear"></i> <?php echo $data['usuario']['direccion']; ?></p>
                                <hr>
                                ...
                                <p class="text-muted font-size-sm"> <?php echo ($data['usuario']['rol'] == 1) ? 'ADMINISTRADOR' : 'INSTRUCTOR'; ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <form id="formularioPerfil" autocomplete="off">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input disabled type="text" class="form-control" id="direccionPerfil" name="direccionPerfil" value="<?php echo $data['usuario']['direccion']; ?>" />
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-sm-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="submit" class="btn btn-info text-white px-4" id="btnGuardarCambios" value="Guardar Cambios" />
                                </div>
                            </div>
                        </form>
                    </div>
