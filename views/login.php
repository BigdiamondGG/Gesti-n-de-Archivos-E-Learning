                                        ...
                                        <form class="row g-3" id="formulario" method="POST" autocomplete="off">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="input-group" id="show_hide_password">
                                                    <input type="password" class="form-control border-end-0" id="clave" name="clave" placeholder="Contxraseña">
                                                    <a href="javascript:;" class="input-group-text bg-transparent  bg-primary"><i class='bx bx-hide text-white'></i></a>
                                                </div>
                                                <span id="errorClave" class="text-danger"></span>
                                            </div>
                                            <div class="col-md text-end"> <a class="text-white" href="<?php echo BASE_URL . 'principal/forgot'; ?>">Olvidaste tu contraseña?</a>
                                            </div>
                                            <div class="col-12">
                                                <div class="d-grid">
