...
class Usuarios extends Controller
{
    ...
    public function listar()
    {
        ...
        for ($i = 0; $i < count($data); $i++) {
            ...
            <button class="btn btn-info" type="button" onclick="editarUsuario(' . $data[$i]['id'] . ')"><i class="fas fa-edit text-light"></i></button>
            </div>';
        }
    ...
    public function registrar()
    {
        ...
        if (isset($_POST)) {
            if (empty($_POST['nombres'])) {
                ...
                $res = array('msg' => 'EL CARGO ES REQUERIDO', 'type' => 'warning');
    ...
    //metodo para Restaurar usuario Inactivo
    ...
    public function modificarDatos()
    {
        ...
        if (!empty($name)) {
            ...
            $destino = 'assets/images/avatars/' . $perfil;
        }
        ...
        if (empty($nombre)) {
            ...
            if (empty($claveNueva)) {
                ...
                if (empty($verificarCorreo)) {
                    ...
                    if (empty($verificarTel)) {
                        $data = $this->model->modificarDatos($nombre, $apellidos, $correo, $telefono, $direccion, $hash, $perfil, $this->id_usuario);
                        if ($data == 1) {
                            if (!empty($name)) {
